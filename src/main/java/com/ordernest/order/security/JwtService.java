package com.ordernest.order.security;
...
public class JwtService {
    ...
    public UUID extractUserId(String token) {
        Jwt jwkJwt = decodeWithJwks(token);
        String rawUserId = jwkJwt != null ? jwkJwt.getClaimAsString("userId") : extractAllClaims(token).get("userId", String.class);
        if ((rawUserId == null || rawUserId.isBlank()) && jwkJwt != null) {
            rawUserId = jwkJwt.getSubject();
        }
